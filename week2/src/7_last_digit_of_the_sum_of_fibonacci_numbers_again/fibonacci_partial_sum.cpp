...
long long get_fibonacci_partial_sum_naive1(long long from, long long to) {
    long long sum = 0;
...
long long get_fibonacci_partial_sum_naive2(long long from, long long to) {
    if (to <= 1)
        return to;
...
int main(int argc, char** argv) {
    long long from, to;
    std::cin >> from >> to;
    /*std::cout << get_fibonacci_partial_sum_naive1(from, to) << '\n';*/
    std::cout << fibonacci_partial_sum_fast(from, to) << std::endl;
    return 0;
}
